# -*- coding: utf-8 -*-
#
# microbit_tutorials documentation build configuration file, created by
...
copyright = u'2016, Rae Harbird, Stephen Hailes'
author = u'Rae Harbird, Stephen Hailes'
...
htmlhelp_basename = 'microbit_tutorialsdoc'
...
# These options copied from BBC Microbit Python RTD config file
